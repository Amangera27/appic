...
export default function ContactSection() {
  ...
  return (
    <>
      ...
      <div ref={wrapperRef} className="relative w-full min-h-screen overflow-hidden py-10 md:py-20 flex flex-col justify-center" style={{ backgroundColor: "#faf9f8" }}>
          ...
          <div className="relative w-full flex flex-col justify-between py-4 md:py-6 px-4 md:px-10 z-10 pointer-events-none">
            
            {/* ── Headline ── */}
            <div ref={headlineRef} className="text-center w-full max-w-[1260px] mx-auto pointer-events-none mt-2">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#FFECEF] border border-[#FFD2D8] mb-2 sm:mb-3">
                <span className="text-xs text-[#E40D28]">🎧</span>
                <span className="text-[10px] font-extrabold tracking-[0.15em] text-[#E40D28] uppercase">We're all ears</span>
              </div>
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-[48px] font-black text-zinc-950 tracking-tight leading-[1.1] mb-2">
                Let's Build Something <span className="relative inline-block text-[#E40D28]">
                  Amazing!
                  <svg className="absolute left-0 bottom-[-4px] w-full h-[6px] text-[#E40D28]/40" viewBox="0 0 100 10" preserveAspectRatio="none">
                    <path d="M 0 5 Q 50 10 100 5 Q 50 0 0 5" fill="currentColor"/>
                  </svg>
                </span>
              </h2>
              <p className="text-zinc-500 text-[11px] sm:text-xs font-semibold tracking-wide flex items-center justify-center gap-1">
                <span className="text-[#ff6b35]">⚡</span>
                <span className="text-[#ff6b35]">⚡</span>
                <span>Share your ideas, and let's <span className="text-[#E40D28] font-bold">turn them into reality.</span></span>
                <span className="text-[#ff6b35]">⚡</span>
                <span className="text-[#ff6b35]">⚡</span>
              </p>
            </div>
            ...
            {/* ── Form + Info ── */}
            <div ref={formWrapRef} className="w-full max-w-[1260px] mx-auto pointer-events-auto mt-4">
