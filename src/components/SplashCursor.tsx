...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    const contextSetup = getWebGLContext(canvas);
    if (!contextSetup) return;

    const { gl, ext } = contextSetup;
  ...
  return (
    <div
      style={{
        ...
        top: 0,
        left: 0,
        zIndex: 999, // Layers perfectly on top of all elements to render the splash, but clicks pass through!
        pointerEvents: "none",
        width: "100%",
        height: "100%"
      }}
